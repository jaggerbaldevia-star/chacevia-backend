...
- a short explanation of the reasoning or how you reached it, so the student actually learns (not just copies).
...
{ "items": [ { "question": "the question text", "answer": "the answer", "explanation": "1-3 sentences on why / how" } ] }

If the document has no answerable questions, return { "items": [] }. Be accurate and clear; explanations teach the concept.`
